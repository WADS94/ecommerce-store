    ...
    <>
      ...
      <form className="row  form-container" onSubmit={submitHandler}>
        <div className="col-md-6">
          <div className="form">
            <label htmlFor="account-fn">Nume utilizator</label>
            <input
        ...
        <div className="col-md-6">
          <div className="form">
            <label htmlFor="account-email">Adresa de mail</label>
            <input
              className="form-control"
              type="email"
              value={email}
        ...
        <div className="col-md-6">
          <div className="form">
            <label htmlFor="account-pass">Noua parola</label>
            <input
              className="form-control"
              type="password"
              value={password ?? ""}
        ...
        <div className="col-md-6">
          <div className="form">
            <label htmlFor="account-confirm-pass">Confirma parola</label>
            <input
              className="form-control"
              type="password"
